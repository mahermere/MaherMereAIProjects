// Cross-platform PDF generation utility for SOA using Syncfusion PDF.
...
namespace TripleS.SOA.AEP.UI.Services
{
    public static class PdfService
    {
        public static byte[] GenerateSOAPdf(
            ...
            float y = 20;
            page.Graphics.DrawString($"Signature of Authority (SOA) - SOA#: {soaNumber}", font, PdfBrushes.Black, new Syncfusion.Drawing.PointF(20, y));
            y += 40;
